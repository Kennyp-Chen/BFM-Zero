...
class IsaacGym(BaseSimulator):
    ...
    def add_keyboard_callback(self, key, func, name):
        self.gym.subscribe_viewer_keyboard_event(self.viewer, key, name)
        self.keyboard_callbacks[name] = func
    ...
    def set_actor_root_state_tensor(self, set_env_ids, root_states):
        self.robot_root_states[set_env_ids] = root_states[set_env_ids]
    ...
    def set_dof_state_tensor(self, set_env_ids, dof_states):
        self.dof_pos[set_env_ids] = dof_states[set_env_ids, ..., 0]
        self.dof_vel[set_env_ids] = dof_states[set_env_ids, ..., 1]
        set_env_ids_int32 = set_env_ids.to(torch.int32)
    ...
    def render(self, sync_frame_time=True):
        ...
        for evt in self.gym.query_viewer_action_events(self.viewer):
            ...
            for key, func in self.keyboard_callbacks.items():
                if evt.action == key and evt.value > 0:
                    func()
